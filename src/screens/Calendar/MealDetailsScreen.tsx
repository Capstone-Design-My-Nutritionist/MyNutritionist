...
const MealDetailsScreen = () => {
  ...
  const processApiData = (apiData: MealData, selectedDate: string): DisplayMealData => {
    ...
    return {
      ...
      totalCalories: mainFood.nutrition.energy,
      carbs: parseFloat(mainFood.nutrition.carbohydrate.toFixed(1)),
      protein: parseFloat(mainFood.nutrition.protein.toFixed(1)),
      fat: parseFloat(mainFood.nutrition.fat.toFixed(1)),
